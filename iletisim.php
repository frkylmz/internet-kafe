    ...
    <div class="container-fluid height">
        <div class="row height">
          <div class="col height">
            ...
            <div class="mt-4">
                <h1 class="text-center">İletişim Bilgilerimiz</h1>
                <ul class="mt-4">
                    <li class="mb-3">Adres: Adatepe, Erdem Cd., 35400 Buca/İzmir</li>
                    <li class="mb-3">Telefon: (0232) 412 12 12</li>
                    <li class="mb-3">E-posta: bbfinternetkafe@gmail.com</li>
                    <li class="mb-3">Çalışma Saatleri: Pazartesi-Cumartesi 08:00-23:00</li>
                </ul>
            </div>
